...
use lspee_daemon::{
    Attach, AttachCapabilities, Call, CallOk, ClientKind, ClientMeta, ControlEnvelope, Release,
    SessionKeyWire, StreamMode, TYPE_ATTACH, TYPE_ATTACH_OK, TYPE_CALL, TYPE_CALL_OK, TYPE_RELEASE,
    TYPE_RELEASE_OK,
};
use serde::Serialize;
...
mod tests {
    ...
    fn spawn_test_daemon(root: &Path) -> tokio::task::JoinHandle<anyhow::Result<()>> {
