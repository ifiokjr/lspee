...
const PROJECT_CONFIG_FILE: &str = "monokit.toml";
const USER_CONFIG_DIR: &str = ".config/monokit";
...
impl EffectiveConfig {
	...
	///
	/// ```
	/// use monokit_config::{EffectiveConfig, LspConfig};
	///
...
/// ```
/// use std::path::Path;
/// use monokit_config::{EffectiveConfig, hash_identity};
///
...
args = ["lsp", "stdio"]
"#;
		fs::write(dir.join("monokit.toml"), config).unwrap();
