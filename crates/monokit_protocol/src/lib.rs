//! Wire types for the monokit control and stream protocols.
//!
//! Every message exchanged between an editor shim and the monokit daemon is
...
///
/// ```
/// use monokit_protocol::{ControlEnvelope, PROTOCOL_VERSION, TYPE_PING};
/// use serde_json::Value;
///
...
///
/// ```
/// use monokit_protocol::{Attach, SessionKeyWire, ClientMeta};
///
/// let attach = Attach {
...
///
/// ```
/// use monokit_protocol::SessionKeyWire;
///
